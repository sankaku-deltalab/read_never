defmodule ReadNeverWeb.BookLiveTest do
  use ReadNeverWeb.ConnCase

  import Phoenix.LiveViewTest
  import ReadNever.BookShelfFixtures

  @create_attrs %{name: "some name", filepath: "some filepath", last_read_datetime: "2023-07-22T08:34:00Z"}
  @update_attrs %{name: "some updated name", filepath: "some updated filepath", last_read_datetime: "2023-07-23T08:34:00Z"}
